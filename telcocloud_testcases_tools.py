...
class openstack_utils(object):  # should contains the open/SetUp/TearDown
    ...
    def open_connection_to_openstack(self):
        if self.admin:
            ...
            print("Generating NON Admin Token")
            self.auth = v3.Password(auth_url=AUTH_URL,
                                    username="netcracker",
                                    password="NC_VNFM@123",
                                    project_name="vGIFW_Project",
                                    project_id="83aaf48e404d4e1ebbfec428e88575cd",
                                    user_domain_name="vnfm_nc_domain",
                                    project_domain_name="vnfm.NC.Domain",
